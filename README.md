# AI-based Healthcare Chatbot Disease Detection System(DiagnoBot)
...
## Cancer Detection Page: This is just a simple form that takes patient input for cancer diagnosis & predicts if the patient is likelihood to have the disease or not.
...
## Chatbot Index Page: This page deals with launching the chatbot & beginning the communication by sending greetings to patient
